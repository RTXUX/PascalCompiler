namespace PascalCompiler.Lexical.Lexer {
    ...
    /// <summary>
    /// Represents a provider of <see cref="IClassificationType"/> objects for the <c>Pascal</c> language.
    /// </summary>
    /// <remarks>
    ...
    public partial class PascalClassificationTypeProvider : IPascalClassificationTypeProvider {
        ...
        /// <summary>
        /// Initializes a new instance of the <c>PascalClassificationTypeProvider</c> class.
        /// </summary>
        public PascalClassificationTypeProvider() : 
                this(null) {
        }
        ...
        public PascalClassificationTypeProvider(IHighlightingStyleRegistry targetRegistry) {
            ...
            get {
                if ((this.stringValue == null)) {
                    ...
                    if ((this.stringValue == null)) {
                        ...
                        this.registryValue.Register(this.stringValue, new HighlightingStyle(Color.FromArgb(255, 128, 0, 0)));
                    }
                }
